...
- (instancetype) initWithDictionary: (NSDictionary *) dic {
    if((self = [self init])) {
		...
		_prepaidUnits = (![dic objectForKey: @"prepaidUnits"] || [ [dic objectForKey: @"prepaidUnits"] isKindOfClass:[NSNull class]] )?_prepaidUnits:[[MSDirectoryServicesLicenseUnitsDetail alloc] initWithDictionary: [dic objectForKey: @"prepaidUnits"]];

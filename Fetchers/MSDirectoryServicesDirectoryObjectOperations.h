...
#ifndef MSDIRECTORYSERVICESDIRECTORYOBJECTOPERATIONS_H
#define MSDIRECTORYSERVICESDIRECTORYOBJECTOPERATIONS_H
...
/** MSDirectoryServicesDirectoryObjectOperations
 *
 */
@interface MSDirectoryServicesDirectoryObjectOperations : MSOrcOperations

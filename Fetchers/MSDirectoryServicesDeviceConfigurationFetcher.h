...
#ifndef MSDIRECTORYSERVICESDEVICECONFIGURATIONFETCHER_H
#define MSDIRECTORYSERVICESDEVICECONFIGURATIONFETCHER_H
...
/** MSDirectoryServicesDeviceConfigurationFetcher
 *
 */
@interface MSDirectoryServicesDeviceConfigurationFetcher : MSOrcEntityFetcher

@property (copy, nonatomic, readonly) MSDirectoryServicesDeviceConfigurationOperations *operations;

- (instancetype)initWithUrl:(NSString*)urlComponent parent:(id<MSOrcExecutable>)parent;
- (void)readWithCallback:(void (^)(MSDirectoryServicesDeviceConfiguration *, MSOrcError *))callback;
- (void)update:(MSDirectoryServicesDeviceConfiguration *)DeviceConfiguration callback:(void (^)(MSDirectoryServicesDeviceConfiguration *, MSOrcError*))callback ;

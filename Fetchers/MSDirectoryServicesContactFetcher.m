...
@implementation MSDirectoryServicesContactFetcher

@synthesize operations = _operations;

- (instancetype)initWithUrl:(NSString *)urlComponent parent:(id<MSOrcExecutable>)parent {

    if (self = [super initWithUrl:urlComponent parent:parent asClass:[MSDirectoryServicesContact class]]) {

		_operations = [[MSDirectoryServicesContactOperations alloc] initOperationWithUrl:urlComponent parent:parent];
    }

    return self;
}

- (void)update:(id)entity callback:(void (^)(MSDirectoryServicesContact *Contact, MSOrcError *e))callback {
...
- (void) readWithCallback:(void (^)(MSDirectoryServicesContact *Contact, MSOrcError *error))callback {

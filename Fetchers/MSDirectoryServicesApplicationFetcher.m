...
- (void)update:(id)entity callback:(void (^)(MSDirectoryServicesApplication *Application, MSOrcError *e))callback {
...
- (void) readWithCallback:(void (^)(MSDirectoryServicesApplication *Application, MSOrcError *error))callback {
    [super readWithCallback:^(id response, MSOrcError *error) {
        callback(response, error);
    }];
}
- (MSOrcStreamFetcher *)mainLogo {

    return [[MSOrcStreamFetcher alloc] initWithUrl:@"mainLogo" parent:self];
}

- (MSDirectoryServicesExtensionPropertyCollectionFetcher *)extensionProperties {
...
- (MSDirectoryServicesExtensionPropertyFetcher *)extensionPropertiesById:(NSString *)identifier {
    ...
    return [[[MSDirectoryServicesExtensionPropertyCollectionFetcher alloc] initWithUrl:@"extensionProperties" parent:self asClass:[MSDirectoryServicesExtensionProperty class]] getById:identifier];

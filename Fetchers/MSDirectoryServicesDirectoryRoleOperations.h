...
#ifndef MSDIRECTORYSERVICESDIRECTORYROLEOPERATIONS_H
...
/** MSDirectoryServicesDirectoryRoleOperations
 *
 */
@interface MSDirectoryServicesDirectoryRoleOperations : MSDirectoryServicesDirectoryObjectOperations

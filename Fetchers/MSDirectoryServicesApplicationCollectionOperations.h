...
#ifndef MSDIRECTORYSERVICESAPPLICATIONCOLLECTIONOPERATIONS_H
#define MSDIRECTORYSERVICESAPPLICATIONCOLLECTIONOPERATIONS_H
...
/** MSDirectoryServicesApplicationCollectionOperations
 *
 */

...
@implementation MSDirectoryServicesContactCollectionFetcher

- (instancetype)initWithUrl:(NSString *)urlComponent parent:(id<MSOrcExecutable>)parent {

    return [super initWithUrl:urlComponent parent:parent asClass:[MSDirectoryServicesContact class]];
}

- (void)add:(MSDirectoryServicesContact*)entity callback:(void (^)(MSDirectoryServicesContact *mSDirectoryServicesContact, MSOrcError *error))callback {
...
- (MSDirectoryServicesContactFetcher *)getById:(id) identifier {
    ...
    return [[MSDirectoryServicesContactFetcher alloc] initWithUrl:[[NSString alloc] initWithFormat:@"('%@')" , identifier] parent:self];
}
